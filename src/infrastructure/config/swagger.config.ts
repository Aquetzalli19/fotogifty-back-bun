...
const swaggerOptions: Options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "Una API REST construida con Express, Bun y TypeScript usando arquitectura hexagonal",
      contact: {
        name: "API Support",
        ...
        Pedido: {
          ...
          properties: {
            ...
            imagenes: {
              ...
              example: [
                "https://s3.amazonaws.com/bucket/foto1.jpg",
                "https://s3.amazonaws.com/bucket/foto2.jpg",
              ],
            },
            creado_en: {
              type: "string",
